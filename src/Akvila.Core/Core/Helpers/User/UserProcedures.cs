...
public class UserProcedures : IUserProcedures {
    ...
    public async Task<IUser> GetAuthData(string login,
        ...
        authUser.Manager = _akvilaManager;
    ...
    public Task<Stream> GetSkin(IUser user) {
        return _akvilaManager.Integrations.TextureProvider.GetSkinStream(user.TextureSkinUrl);
    }

    public Task<Stream> GetCloak(IUser user) {
        return _akvilaManager.Integrations.TextureProvider.GetCloakStream(user.TextureCloakUrl);
    }

    public Task<Stream> GetHead(IUser user) {
        return _akvilaManager.Integrations.TextureProvider.GetHeadByNameStream(user.Name);
    }
