...
namespace Akvila.Core.Helpers.Files;
    ...
    public async Task<IFileInfo?> DownloadFileStream(
        ...
        switch (_launcherInfo.StorageSettings.StorageType) {
            case StorageType.LocalStorage:
                ...
                // 27.05.2025 playgamesgo: this is a confusing part for me, or I'm missing something, or this part requires more comments
                ...
                } else if (localFileInfo != null) { // Uploading minecraft files
    ...
    public async Task<(Stream File, string fileName, long Length)> GetFileStream(string fileHash,
        ...
        switch (_launcherInfo.StorageSettings.StorageType) {
            case StorageType.LocalStorage:
                ...
                // 27.05.2025 playgamesgo: loading result of previous confusing part, this really needs more comments, or refactoring
                if (localFileInfo is not null && File.Exists(localFileInfo.FullPath)) {
                    ...
                    fileStream = new FileStream(localFileInfo.FullPath, FileMode.Open, FileAccess.Read,
                        FileShare.Read);
                ...
                try {
                    ...
                    if (metadata is null) {
                        ...
                        getObjectArgs = new GetObjectArgs()
                            ...
                            .WithObject(fileHash)
                            .WithCallbackStream(
                                async (stream, token) => await stream.CopyToAsync(fileStream, token));
                    }
