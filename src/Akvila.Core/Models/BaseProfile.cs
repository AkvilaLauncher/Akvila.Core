...
public class BaseProfile : IGameProfile {
    ...
    public Task<bool> CanLoadMods() {
        return Task.FromResult(Loader != AkvilaCore.Interfaces.Enums.GameLoader.Undefined &&
                               Loader != AkvilaCore.Interfaces.Enums.GameLoader.Vanilla);
    }
}
